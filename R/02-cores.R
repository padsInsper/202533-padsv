...
p1 + 
  ...
  ggplot2::theme( 
    plot.title = ggplot2::element_text(family = "GT Ultra Fine", size = 50),
    plot.subtitle = ggplot2::element_text(family = "Inter", size = 30),
    text = ggplot2::element_text(family = "Inter", size = 20)
  )
